...
• Not Mandatory to perform Copy and Cut operations using Ctrl+C and Ctrl+X
  Even an application's Copy and Cut will be transferred to Clipjump.
...
>chaz for re-designing GUIs and many other things.
>Ken, Luke, Morpheus and more for pointing out critical bugs and presenting amazing suggestions. 
...
•Better History and Settings Tool feature-wise.
•Fixed Minor Bugs
